...
pub enum WalletAbiError {
    ...
    Derivation(#[from] simplex::simplicityhl::elements::bitcoin::bip32::Error),
    ...
    #[error("PSET error: {0}")]
    Pset(#[from] simplex::simplicityhl::elements::pset::Error),

    #[error("PSET blinding error: {0}")]
    PsetBlind(#[from] simplex::simplicityhl::elements::pset::PsetBlindError),

    #[error("Transaction amount proof verification failed: {0}")]
    AmountProofVerification(#[from] simplex::simplicityhl::elements::VerificationError),
...
pub enum ProgramError {
    ...
    Pruning(simplex::simplicityhl::simplicity::bit_machine::ExecutionError),

    #[error("Failed to construct a Bit Machine with enough space: {0}")]
    BitMachineCreation(#[from] simplex::simplicityhl::simplicity::bit_machine::LimitError),

    #[error("Failed to execute program on the Bit Machine: {0}")]
    Execution(simplex::simplicityhl::simplicity::bit_machine::ExecutionError),
