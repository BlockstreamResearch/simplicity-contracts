...
use simplicityhl::elements::{AddressParams, OutPoint, Sequence, TxOut, TxOutSecrets};
...
pub fn build_option_creation(
    ...
    let (first_asset_id, _) = first_tx_out.explicit()?;
    let (second_asset_id, _) = second_tx_out.explicit()?;
