...
pub struct SmtStorageProgram {
    program: Program,
}
impl SmtStorageProgram {
    pub const SOURCE: &'static str = derived_smt_storage::SMT_STORAGE_CONTRACT_SOURCE;
    #[must_use]
...
impl AsRef<Program> for SmtStorageProgram {
    fn as_ref(&self) -> &Program {
        &self.program
    }
}
impl AsMut<Program> for SmtStorageProgram {
    fn as_mut(&mut self) -> &mut Program {
        &mut self.program
    }
}
include_simf!("simf/smt_storage.simf");
