...
use simplicityhl_core::{
    ...
    TaprootPubkeyGen, broadcast_tx, control_block, create_p2tr_address, derive_public_blinder_key,
    fetch_utxo, finalize_p2pk_transaction, get_new_asset_entropy, get_p2pk_address,
