...
use simplicityhl_core::{
    ...
    TaprootPubkeyGen, broadcast_tx, derive_public_blinder_key, fetch_utxo,
    finalize_p2pk_transaction, finalize_transaction, get_new_asset_entropy, get_p2pk_address,
    get_random_seed,
};
...
impl Options {
    pub fn handle(&self) -> Result<()> {
        match self {
            ...
            Options::CancellationOption {
                ...
                let tx = Self::cancellation_option(
                    collateral_utxo,
                    option_asset_utxo,
                    grantor_asset_utxo,
                    fee_utxo,
    ...
    fn funding_option(
        ...
        let mut first_asset_entropy_bytes: AssetEntropyBytes =
            first_entropy_hex.try_into().unwrap();
        first_asset_entropy_bytes.reverse();

        let mut second_asset_entropy_bytes: AssetEntropyBytes =
        ...
        let second_unblinded =
            grantor_utxo.unblind(&Secp256k1::new(), blinding_key.secret_key())?;
