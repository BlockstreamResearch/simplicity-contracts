...
use simplicityhl_core::{
    broadcast_tx, derive_public_blinder_key, fetch_utxo, finalize_p2pk_transaction,
    finalize_transaction, get_new_asset_entropy, get_p2pk_address, get_random_seed,
    AssetEntropyBytes, Encodable, TaprootPubkeyGen, LIQUID_TESTNET_BITCOIN_ASSET,
    LIQUID_TESTNET_GENESIS,
};

use crate::modules::utils::derive_keypair;
use contracts::{
    build_dcd_witness, finalize_dcd_transaction_on_liquid_testnet, get_dcd_program, oracle_msg,
    DCDArguments, DCDRatioArguments,
};
...
impl Dcd {
    pub fn handle(&self) -> Result<()> {
        match self {
            ...
            Dcd::MakerFundingPath {
                ...
                let tx = Self::maker_funding_path(
                    &keypair,
                    &blinding_key,
                    *filler_token_utxo,
                    *grantor_collateral_token_utxo,
            ...
            Dcd::TakerFundingPath {
                ...
                let tx = Self::taker_funding_path(
                    &keypair,
                    *filler_token_utxo,
                    *collateral_utxo,
                    dcd_taproot_pubkey_gen,
            ...
            Dcd::TakerEarlyTermination {
                ...
                let tx = Self::taker_early_termination(
                    &keypair,
                    *collateral_utxo,
                    *filler_token_utxo,
                    *fee_utxo,
            ...
            Dcd::MakerCollateralTermination {
                ...
                let tx = Self::maker_collateral_termination(
                    &keypair,
                    *collateral_utxo,
                    *grantor_collateral_token_utxo,
                    *fee_utxo,
            ...
            Dcd::MakerSettlementTermination {
                ...
                let tx = Self::maker_settlement_termination(
                    &keypair,
                    *settlement_asset_utxo,
                    *grantor_settlement_token_utxo,
                    *fee_utxo,
    ...
    fn maker_settlement_termination(
        keypair: &Keypair,
        settlement_asset_utxo: OutPoint,
        grantor_settlement_token_utxo: OutPoint,
        fee_utxo: OutPoint,
    ...
    fn maker_collateral_termination(
        keypair: &Keypair,
        collateral_utxo: OutPoint,
        grantor_collateral_token_utxo: OutPoint,
        fee_utxo: OutPoint,
    ...
    fn maker_funding_path(
        ...
        dcd_taproot_pubkey_gen: &str,
        fee_amount: u64,
        first_entropy_hex: IVec,
        second_entropy_hex: IVec,
        third_entropy_hex: IVec,
        dcd_arguments: &DCDArguments,
    ) -> anyhow::Result<Transaction> {
        let filler_utxo = fetch_utxo(filler_token_utxo)?;
